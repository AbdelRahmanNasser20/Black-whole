...
// Not imported from shell.js on purpose: index.html loads shell as `shell.js?v=…`, so a tab that imports `./shell.js`
// pulls in a SECOND shell instance that boots every tab mid-evaluation (TDZ crash).
function getParams() {
  const out = {};
